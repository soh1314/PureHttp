//
//  CcaoHuaHttpConnectionOperation.m
//  CcaoHuaLogin
//
...
static dispatch_queue_t http_request_operation_processing_queue() {
    ...
    dispatch_once(&onceToken, ^{
        af_http_request_operation_processing_queue = dispatch_queue_create("com.caohua.http-request.processing", DISPATCH_QUEUE_CONCURRENT);
    });
...
@interface CcaoHuaHttpConnectionOperation ()
...
@implementation CcaoHuaHttpConnectionOperation
@dynamic response;
@dynamic lock;
...
- (instancetype)initWithRequest:(NSURLRequest *)urlRequest {
    ...
    self.responseSerializer = [CHHTTPResponseSerializer serializer];
...
- (void)setCompletionBlockWithSuccess:(void (^)(CcaoHuaHttpConnectionOperation *operation, id responseObject))success
...
- (id)copyWithZone:(NSZone *)zone {
    CcaoHuaHttpConnectionOperation *operation = [super copyWithZone:zone];
